...
/***/ function(module, exports, __webpack_require__) {
	...
	var mealEvents = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(8);
	var editMealTemplate = __webpack_require__(13);

	var api = __webpack_require__(34);
	var ui = __webpack_require__(35);
	var store = __webpack_require__(10);

	var onCreateMeal = function onCreateMeal(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.createMeal(data).then(function (response) {
	    store.meal = response.meal;
	    onGetMeals();
	  }).then(ui.createMealSuccess).catch(ui.createMealFailure);
	};

	var onGetMeals = function onGetMeals() {
	  api.getMeals().then(function (response) {
	    store.meals = response.meals;
	    ui.getMealSuccess();
	  }).catch(ui.getMealFailure);
	};

	var onUpdateMeal = function onUpdateMeal(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateMeal(data).then(ui.UpdateMealSuccess).then(function () {
	    onGetMeals();
	...
	var openEditModal = function openEditModal(event) {
	  ...
	  var currentMeal = store.meals.filter(function (meal) {
	...
	var onRemoveMeal = function onRemoveMeal(event) {
	  var mealId = $(this).data().mealid;
	  event.preventDefault();
	  api.removeMeal(mealId).then(ui.removeMealSuccess).then(onGetMeals).catch(ui.removeMealFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <form class=\"edit-meal\">\n      <input type=\"hidden\" name=\"meal[id]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <input name=\"meal[eaten_on]\" type=\"date\" class=\"input title\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.eaten_on : stack1), depth0))
	    + "\">\n      <input name=\"meal[title]\" type=\"text\" placeholder=\"Meal Title\" class=\"input title\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.title : stack1), depth0))
	    + "\">\n      <textarea class=\"form-control\" name=\"meal[description]\" rows=\"3\" placeholder=\"Describe your meal\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.description : stack1), depth0))
	    + "</textarea>\n      <h5>How did you feel? (On a scale from 1-10)</h5>\n      <select class=\"form-control\" name=\"meal[feeling]\"  value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1), depth0))
	    + "\">\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,1,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"1\">1</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,2,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"2\">2</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,3,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"3\">3</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,4,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"4\">4</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,5,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"5\">5</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,6,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"6\">6</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,7,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"7\">7</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,8,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"8\">8</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,9,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"9\">9</option>\n        <option "
	    + alias2(__default(__webpack_require__(33)).call(alias3,10,((stack1 = (depth0 != null ? depth0.meal : depth0)) != null ? stack1.feeling : stack1),{"name":"feelingValue","hash":{},"data":data}))
	    + " value=\"10\">10</option>\n      </select>\n      <button type='submit' id=\"edit-button\" class=\"inputButton\">Submit</button>\n    </form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMeal = function createMeal(data) {
	  return $.ajax({
	...
	var removeMeal = function removeMeal(id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var mealTemplate = __webpack_require__(36);

	var createMealSuccess = function createMealSuccess() {
	  $("#create-meal")[0].reset();
	...
	var createMealFailure = function createMealFailure(err) {
	  if (err.status === 400) {
	    //unauthorized
	...
	var getMealSuccess = function getMealSuccess() {

	  var sortedMeals = store.meals.sort(function (a, b) {
	    return new Date(b.eaten_on) - new Date(a.eaten_on);
	  });

	  var $meals = mealTemplate({ meals: sortedMeals });

	  $('.meal-show').html($meals);
	};

	var updateMealSuccess = function updateMealSuccess() {
	  $('#editModal').modal('hide');
	...
	var removeMealSuccess = function removeMealSuccess() {
	  $('#delete-meal').val('');
	...
	var removeMealFailure = function removeMealFailure() {
	...
	module.exports = {
	  createMealSuccess: createMealSuccess,
	  createMealFailure: createMealFailure,
	  getMealSuccess: getMealSuccess,
	  updateMealSuccess: updateMealSuccess,
	  removeMealSuccess: removeMealSuccess,
	  removeMealFailure: removeMealFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <tr>\n      <td>"
	    ...
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.eaten_on : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.feeling : stack1), depth0))
	    + "</td>\n      <td>\n        <button class=\"btn btn-primary meal-edit\" data-mealId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" >Edit</button>\n        <button class=\"btn btn-danger meal-delete\" data-mealId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete</button>\n      </td>\n    </tr>\n";
	  ...
	  return "<table>\n  <thead>\n    <tr>\n      <th>Title</th>\n      <th>Date</th>\n      <th>Description</th>\n      <th>Feeling</th>\n      <th>Actions</th>\n    </tr>\n  </thead>\n\n  <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.meals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n\n</table>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "bad3ae8e0c0f8428c4a50cfe1e357e18.jpg";
